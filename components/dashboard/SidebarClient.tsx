...
const menuItems: MenuItem[] = [
  ...
  { label: 'Truck',             href: '/dashboard/truck',              icon: '🚛', roles: ['Admin','Kepala_WH','Sopir'] },  { label: 'Kategori Material', href: '/dashboard/kategori-material',  icon: '🏷️', roles: ['Admin','Teknik_Sipil'] },
